...
class TutorialViewModel extends ChangeNotifier {
  ...
  String get currentMessage {
    switch (_currentStep) {
      ...
      case 4:
        return 'にゃんこを仲間にするには、必要なさかなの数が決まっておる。にゃんこの下にあるさかなの数以上のさかなを置かないと仲間にできんのじゃ。';
      case 5:
        return 'まずは左の「しろねこ」におさかなを3匹置いておくれ。下のさかなをドラッグしてしろねこのお皿まで移動させるのじゃ。';
      case 6:
      ...
      case 24:
        return 'このアイテムを置くとどれだけさかなを置いてもお互いにキャラクターをゲットする事はできないのじゃ。';
      case 25:
        return 'まずは一番左の「しろねこ」に「びっくりホーン」を置いてみるのじゃ。';
      case 26:
        return 'よし！これであいてとお主、どちらがさかなを置いてもこのしろねこはゲットできないぞ。';
      case 27:
        return '次に、真ん中の「しろねこ」にさかなを3匹置いてみるのじゃ。';
      case 28:
        return 'ふむ、さかなを置いても安心はできんぞ。相手の方が多くのさかなを置いた場合は、そちらに取られてしまうのじゃ。';
      case 29:
        return '最後に、右の「茶トラ」を取るために、さかなを2匹置いておくのじゃ！';
      case 30:
      ...
      case 33:
        return 'びっくりホーンの効果で誰も仲間にできんかったのう。あいてのさかなを無駄に使わせることができたぞ！';
      case 34:
        return '次は真ん中の「しろ」じゃ。お主は3匹置いたが、相手はどうかのう？';
      case 35:
        return 'おっと！相手は4匹も置いておる。';
      case 36:
        return '残念！お主より多いさかなを置かれてしまった。必要なさかなの数を満たしていても相手より少ないと取られてしまうのじゃ。';
      case 37:
