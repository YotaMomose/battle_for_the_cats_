...
class GameConstants {
  ...
  static const int maxCatCost = 4; // にゃんこのコストの最大値（1～4）
  static const int winCondition = 3; // 勝利に必要なにゃんこの数
  ...
  // イベント
  static const double fatCatEventProbability = 0.15; // ふとっちょにゃんこイベント発生確率
